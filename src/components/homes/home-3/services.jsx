          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="tp-service-section-box text-center pb-35">
                ...
                <h2 className="tp-title">Start growing with <span> </span> 
                  <span className="tp-section-highlight">
                    <svg width="290" height="7" viewBox="0 0 290 11" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M0 0L290 11H0V0Z" fill="#FFDC60" />
                    </svg> Shout Hero
                  </span>
                </h2>
              </div>
