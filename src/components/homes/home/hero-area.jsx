...
const hero_contents = {
  title: 'Become the talk of your town',
  text: <>At Top Pin, we transform franchises and small businesses with the use of stellar social media marketing, exceptional public relations, and authenctic customer reviews.  </>,
  btn_text: 'Visit Case Studies',
  btn_text_2: 'About Top Pin',
  social_links: [
